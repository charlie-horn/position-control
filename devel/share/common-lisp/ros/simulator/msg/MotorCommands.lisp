...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<MotorCommands> is deprecated: use simulator-msg:MotorCommands instead.")))

(cl:ensure-generic-function 'motor_cmd-val :lambda-list '(m))
(cl:defmethod motor_cmd-val ((m <MotorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:motor_cmd-val is deprecated.  Use simulator-msg:motor_cmd instead.")
  (motor_cmd m))
