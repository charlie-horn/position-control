...
(cl:defmethod cl:initialize-instance :after ((m <GazeboState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GazeboState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<GazeboState> is deprecated: use simulator-msg:GazeboState instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <GazeboState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:position-val is deprecated.  Use simulator-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <GazeboState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:quaternion-val is deprecated.  Use simulator-msg:quaternion instead.")
  (quaternion m))
