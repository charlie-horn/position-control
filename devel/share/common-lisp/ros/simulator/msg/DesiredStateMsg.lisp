...
(cl:defmethod cl:initialize-instance :after ((m <DesiredStateMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DesiredStateMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<DesiredStateMsg> is deprecated: use simulator-msg:DesiredStateMsg instead.")))
...
(cl:defmethod x_dot-val ((m <DesiredStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:x_dot-val is deprecated.  Use simulator-msg:x_dot instead.")
  (x_dot m))
...
(cl:defmethod yaw_rate-val ((m <DesiredStateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:yaw_rate-val is deprecated.  Use simulator-msg:yaw_rate instead.")
  (yaw_rate m))
